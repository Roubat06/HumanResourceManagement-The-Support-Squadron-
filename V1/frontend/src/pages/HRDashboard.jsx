...
function Sidebar({ activeTab, setActiveTab }) {
  ...
  return (
    <aside className="w-64 flex-shrink-0 h-screen sticky top-0 bg-white border-r border-[#F0F0F5] flex flex-col p-5">
      ...
      <button className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-[#6C5CE7] to-[#8B7CF6] text-white text-sm font-semibold px-4 py-3 rounded-xl shadow-md shadow-[#6C5CE7]/25 hover:opacity-90 transition mb-6">
        <Plus size={16} />
        New Employee
      </button>
